    ...
    return (
        <div className="min-h-screen bg-[#FDFDFD]">
            ...
            >
                        ...
                        <div className="flex items-center gap-8">
                            ...
                            >
                                ...
                                <div className="hidden sm:block">
                                    <h1 className="text-lg font-black tracking-tighter leading-none text-slate-900 uppercase">
                                        Paws Hub
                                    </h1>
                        ...
                        <div className="hidden md:flex items-center gap-5">
                            <div className="flex items-center gap-3 pr-2 border-r border-slate-100">
                                <div className="text-right">
                                    ...
                                    <p className="text-[10px] font-bold text-orange-500 uppercase tracking-tighter italic">
                                        Manager
                                    </p>
                                </div>
                ...
                <div
                    className={`absolute top-full left-0 w-full px-4 mt-2 transition-all duration-300 ease-in-out ${
                        showingNavigationDropdown
                    ...
                    <div className="bg-white rounded-[2rem] p-4 shadow-2xl border border-slate-50 space-y-2">
                        ...
                        <div className="pt-2 border-t border-slate-50">
                            <Link
                                ...
                                method="post"
                                as="button"
                                className="w-full text-left px-5 py-4 rounded-2xl font-black text-xs text-rose-500 bg-rose-50/50 flex justify-between items-center uppercase tracking-widest"
                            >
